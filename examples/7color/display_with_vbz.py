...
small_image = Image.open("images/charizard.png")
...
img = Image.new("P", (400, 450), color=2)  # Fill with white (color index 1)
...
draw.text((text_x, text_y), Time, fill=0, font=font)  # 4 is RED in Inky's palette
draw.text((text_x, text_y - 50), Date, fill=0, font=font)  # 4 is RED in Inky's palette

# Set the text image on the display
inky_display.set_image_at_position2(img, width=400, height=450, x_offset=25, y_offset=0)
